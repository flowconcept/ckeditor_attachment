...
(function ($, Drupal, CKEDITOR) {
      ...
      editor.widgets.on('instanceCreated', function (event) {
        ...
        widget.on('edit', function (event) {
          ...
          editor.execCommand('editdrupalimage', {
            ...
            dialogTitle: widget.data.src ? editor.config.drupalImage_dialogTitleEdit : editor.config.Attachment_dialogTitleAdd
          });
        });
      });
  ...
  function getFocusedWidget(editor) {
    ...
    if (widget && widget.name === 'attachment') {
      return widget;
    }
